...
export default function MarkdownComponents({ dataKey }: { dataKey: string }) {
    return {
        ...
        a: (props: AnchorHTMLAttributes<HTMLAnchorElement>) => (<CustomLink name={props.children?.toString()!} linkKey={"markdown-" + dataKey} {...props} className="underline break-words hover:text-blue-400 transition-colors">{props.children}</CustomLink>),
